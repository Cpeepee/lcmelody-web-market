...
(
    `b_sticky_bot_tar` VARCHAR (500) DEFAULT('0'),
    `b_sticky_bot_add` VARCHAR (500) DEFAULT('0'),
    `b_sticky_top_tar` VARCHAR (500) DEFAULT('0'),
    `b_sticky_top_add` VARCHAR (500) DEFAULT('0'),
    `b_offer_a_tar` VARCHAR (500) DEFAULT('0'),
    `b_offer_a_add` VARCHAR (500) DEFAULT('0'),
    `b_offer_b_tar` VARCHAR (500) DEFAULT('0'),
    `b_offer_b_add` VARCHAR (500) DEFAULT('0')
);
...
(
    ...
    FOREIGN KEY (`oi_p_id`) REFERENCES t_prodcut(`p_id`)
);
...
(
    ...
    FOREIGN KEY (`cl_p_id`) REFERENCES t_prodcut(`p_id`)
);
...
(
  ...
  FOREIGN KEY (`cv_p_id`) REFERENCES t_prodcut(`p_id`)
);
