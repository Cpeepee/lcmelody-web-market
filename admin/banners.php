        ...
        <section id="section-special-sell-product-inputs">
            <div class="special-product-style">
              <h2 class="text-sepcial-product-style">شناسه محصول ویژه <span>یک</span><h2>
                <input type="text" class="input-product-id-style" name="product-special-1" value="<?php echo $spcial_a;?>">
            </div>

            <div class="special-product-style">
              <h2 class="text-sepcial-product-style">شناسه محصول ویژه <span>دو</span><h2>
                <input type="text" class="input-product-id-style" name="product-special-2" value="<?php echo $spcial_b;?>">
            </div>

            <div class="special-product-style">
              <h2 class="text-sepcial-product-style">شناسه محصول ویژه <span>سه</span><h2>
                <input type="text" class="input-product-id-style" name="product-special-3" value="<?php echo $spcial_c;?>">
            </div>

            <div class="special-product-style">
              <h2 class="text-sepcial-product-style">شناسه محصول ویژه <span>چهار</span><h2>
                <input type="text" class="input-product-id-style" name="product-special-4" value="<?php echo $spcial_d;?>">
            </div>

            <div class="special-product-style">
              <h2 class="text-sepcial-product-style">شناسه محصول ویژه <span>پنج</span><h2>
                <input type="text" class="input-product-id-style" name="product-special-5" value="<?php echo $spcial_e;?>">
            </div>

            <div class="special-product-style">
              <h2 class="text-sepcial-product-style">شناسه محصول ویژه <span>شش</span><h2>
              <input type="text" class="input-product-id-style" name="product-special-6" value="<?php echo $spcial_f;?>">
            </div>
        </section>

        <input type="submit" id="button-save-banners-edits" class="cursor-pointer"  value="ذخیره تغییرات"></input>
      </form>
      </div>
    </div>
