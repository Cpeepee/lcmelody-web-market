...
-- banner
INSERT INTO t_banners (`special_product_a`,`special_product_b`,`special_product_c`,`special_product_d`,`special_product_e`,`special_product_f`) VALUES ('1','2','3','1','4','2');
...
INSERT INTO t_product (`p_title`,`p_brand`,`p_model`,`p_description`,`p_summary_desc`,`p_amount`,`p_type`,`p_price`,`p_discount`,`p_creator_aid`) VALUES ('پنل آکوستیک',
'بور',
'ب۲',
'میکروفن SF-666 محصول شرکت یانمای یک میکروفن خازنی با الگوی الگوریتم قطبی می‌باشد. این میکروفن به راحتی به لپ‌تاپ و گوشی همراه قابل اتصال است (باید توجه داشت که برای اتصال به تلفن همراه باید از تبدیل جداکننده هدفون و میکروفن و یا کارت اکسترنال صدا استفاده کرد). با توجه به الگوریتم ضبط صدای قطبی ، این میکروفن برای ضبط صدا، پادکست، وکال و ... مناسب است. ابعاد مناسب و وزن کم این میکروفن از دیگر قابلیت‌های این محصول خوش‌دست به حساب می‌آید. این محصول به همراه یک پایه برای مشتریان ارایه شده است. ',
'نوع میکروفن :‌  کندانسر ترانزیستوری;نوع کاربری :‌  وکال , سخنرانی ;رابط :  جک 3.5 میلی متری صدا ;فرکانس پاسخ گویی :  50 تا 16000 هرتز ;حساسیت :  55- دسی بل ; فیلتر برش فرکانس‌های پایین : دارد;',
...
INSERT INTO t_product (`p_title`,`p_brand`,`p_model`,`p_description`,`p_summary_desc`,`p_amount`,`p_type`,`p_price`,`p_discount`,`p_creator_aid`) VALUES ('کابل تبدیل جک میکروفن',
'کاچک',
'کیو',
'میکروفن SF-666 محصول شرکت یانمای یک میکروفن خازنی با الگوی الگوریتم قطبی می‌باشد. این میکروفن به راحتی به لپ‌تاپ و گوشی همراه قابل اتصال است (باید توجه داشت که برای اتصال به تلفن همراه باید از تبدیل جداکننده هدفون و میکروفن و یا کارت اکسترنال صدا استفاده کرد). با توجه به الگوریتم ضبط صدای قطبی ، این میکروفن برای ضبط صدا، پادکست، وکال و ... مناسب است. ابعاد مناسب و وزن کم این میکروفن از دیگر قابلیت‌های این محصول خوش‌دست به حساب می‌آید. این محصول به همراه یک پایه برای مشتریان ارایه شده است. ',
'نوع میکروفن :‌  کندانسر ترانزیستوری;نوع کاربری :‌  وکال , سخنرانی ;رابط :  جک 3.5 میلی متری صدا ;فرکانس پاسخ گویی :  50 تا 16000 هرتز ;حساسیت :  55- دسی بل ; فیلتر برش فرکانس‌های پایین : دارد;',
...
-- order items
INSERT INTO t_orders_items (`oi_o_id`,`oi_p_id`,`oi_amount`,`oi_price`,`oi_discount`) VALUES ('1','1','5','500','2500');
INSERT INTO t_orders_items (`oi_o_id`,`oi_p_id`,`oi_amount`,`oi_price`,`oi_discount`) VALUES ('1','2','5','50,000','0');

INSERT INTO t_orders_items (`oi_o_id`,`oi_p_id`,`oi_amount`,`oi_price`,`oi_discount`) VALUES ('2','2','1','60,000','0');
INSERT INTO t_orders_items (`oi_o_id`,`oi_p_id`,`oi_amount`,`oi_price`,`oi_discount`) VALUES ('3','2','1','6,000','600');
INSERT INTO t_orders_items (`oi_o_id`,`oi_p_id`,`oi_amount`,`oi_price`,`oi_discount`) VALUES ('3','4','2','100,000','600');

INSERT INTO t_orders_items (`oi_o_id`,`oi_p_id`,`oi_amount`,`oi_price`,`oi_discount`) VALUES ('4','1','2','10,000','9500');
