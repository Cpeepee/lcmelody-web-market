<div id="customer-menu" style="
margin-right:10px;width:15%;float:right;color:gray;text-align:center;"
  class="set-the-font unselectable">


  <!-- CM = Customer Menu -->
  <div id="CM-button-orders" class="CMB-style def-border cursor-pointer" onclick="window.location.href='my-orders.php'">
    <h2>سفارش ها</h2>
  </div>
