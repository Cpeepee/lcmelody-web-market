...
<div id="offer-a">
  <h2 class="title-offer-a-b set-the-font" style="text-align:center;">تجهیزات جانبی</h2>
  <div class="base-sepcial-product-a-b">

<?php
//fetch info
$fetch_product_info = "SELECT p_id,p_title,p_amount,p_discount,p_price FROM t_product WHERE `p_type` LIKE '%accessories%' OR `p_type` LIKE '%جانبی%' OR `p_type` LIKE '%تجهیزات جانبی%' ORDER BY `p_amount` DESC;";
